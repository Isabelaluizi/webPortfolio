<template>
  <div class="container">
    <div
      class="row justify-content-center justify-content-sm-center animate__animated animate__backInLeft animate__delay-4s"
    ...
    >
            ...
            <g transform="translate(-825.000000, -1100.000000)" id="avatarmaker/Circle">
              <g transform="translate(825.000000, 1100.000000)">
                ...
                >
                  ...
                  <g
                    id="ColorPaletteBlue01"
                    mask="url(#mask-2)"
                    fill="#c2bbff"
                    style="fill: rgb(194, 187, 255);"
                  >
                ...
                <g id="avatarmaker" stroke-width="1" fill-rule="evenodd" mask="url(#mask-4)">
                  ...
                  <g id="Clothing/Collar-+-Sweater" transform="translate(0.000000, 170.000000)">
                    ...
                    <mask id="react-mask-329" fill="white">
                      <use xlink:href="#react-path-328" />
                    </mask>
                    <use
                      id="Clothes"
                      fill="#E6E6E6"
                      fill-rule="evenodd"
                      xlink:href="#react-path-328"
                    />
                    <g
                      id="Color/Palette/Gray-01"
                      mask="url(#react-mask-329)"
                      fill-rule="evenodd"
                      fill="#5d5d5d"
                    >
                  ...
                  <g id="Face" transform="translate(76.000000, 82.000000)" fill="#000000">
                    <g id="Mouth/Smile" transform="translate(2.000000, 52.000000)">
                      ...
                      <mask id="react-mask-206" fill="white">
                        <use xlink:href="#react-path-205" />
                      </mask>
                      <use
                        id="Mouth"
                  ...
                  <g id="Top" stroke-width="1" fill-rule="evenodd">
                    <defs>
                      <rect id="react-path-342" x="0" y="0" width="264" height="280" />
                      <path
                    ...
                    <mask id="react-mask-340" fill="white">
                      <use xlink:href="#react-path-342" />
                    </mask>
                    <g id="Mask" />
                    <g id="Top/Long-Hair/Straight" mask="url(#react-mask-340)">
                      <g transform="translate(-1.000000, 0.000000)">
                        ...
                        >
                          <mask id="react-mask-341" fill="white">
                            <use xlink:href="#react-path-343" />
                          </mask>
                          <use fill="#272C2E" xlink:href="#react-path-343" />
                          <g id="Skin/👶🏽-03-Brown" mask="url(#react-mask-341)" fill="#2c1b18">
      ...
      <div class="col-8 col-sm-8 align-self-end col-md-7 col-xl-8">
        <h2 class="border-bottom" id="about-me-title">About me</h2>
      </div>
      <div class="col-11 col-sm-11 offset-1 offset-sm-1 col-xl-9">
        <h5 id="about-me-text">
          <span id="nice-to-meet">
            <strong>Nice to meet you.</strong>
          </span>
          I am a Full Stack Web Developer who loves coding. I discovered my passion when I was in university and I had the opportunity to study C++.
          <br />I graduated in Chemical Engineering but my dream was always to become someone who works with coding. I followed my desire, went back to College and now I am here sharing a little bit about me.
        </h5>
      </div>
    </div>
    <div class="row justify-content-center justify-content-sm-center" style="overflow: hidden">
      ...
      <div class="col-11 col-sm-11 offset-1 offset-sm-1 col-xl-10">
        <h5
          ...
          data-aos="fade-right"
          data-aos-duration="1000"
        >Technologies that help me build websites.</h5>
      </div>
      <div
        class="col-11 col-sm-11 col-md-8 col-lg-8 col-xl-6"
        data-aos="flip-right"
      ...
      >
        <div class="row justify-content-center justify-content-sm-center">
          <div class="col-5 col-sm-5 col-md-4 col-lg-4 offset-lg-1 col-xl-3 offset-xl-1">
            <div class="tech-item">
              <i class="fab fa-html5 fa-fw fa-2x icon-color"></i> HTML
            </div>
            <div class="tech-item">
              <i class="fab fa-css3-alt fa-fw fa-2x icon-color"></i> CSS
            </div>
            <div class="tech-item">
              <i class="fab fa-sass fa-fw fa-2x icon-color"></i> SCSS
            </div>
            <div class="tech-item">
              <i class="fab fa-php fa-fw fa-2x icon-color"></i> PHP
            </div>
            <div class="tech-item">
              <i class="fab fa-vuejs fa-fw fa-2x icon-color"></i> Vue.js
            </div>
            <div class="tech-item">
              <i class="fas fa-database fa-fw fa-2x icon-color"></i> SQL
            </div>
            <div class="tech-item">
              <i class="fab fa-npm fa-fw fa-2x icon-color"></i> NPM
            </div>
          </div>
          <div class="col-7 col-sm-7 col-md-4 col-lg-4 offset-lg-1 col-xl-5 offset-xl-3">
            <div class="tech-item">
              <svg
                width="25px"
                viewBox="0 0 256 131"
            ...
            <div class="tech-item">
              <i class="fab fa-laravel fa-fw fa-2x icon-color"></i> Laravel
            </div>
            <div class="tech-item">
              <i class="fab fa-bootstrap fa-fw fa-2x icon-color"></i> Bootstrap
            </div>
            <div class="tech-item">
              <i class="fab fa-js-square fa-fw fa-2x icon-color"></i> JavaScript
            </div>
            <div class="tech-item">
              <i class="fab fa-github fa-fw fa-2x icon-color"></i> Git/Github
            </div>
            <div class="tech-item">
              <i class="fab fa-wordpress-simple fa-2x fa-lg icon-color"></i> WordPress
            </div>
            <div class="tech-item">
              <i class="far fa-file-code fa-fw fa-2x icon-color"></i>APIs
            </div>
          </div>
        </div>
      </div>
